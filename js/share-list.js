        ...
        Library = {
            ...
            delItem: function () {
                ...
                $(document).on('click', 'section .del', function () {
                    var id = $(this).data('id'),
                        url = window.Common.domain + '/wx/share/delete?id=' + id + '&callback=?',
                        // url = window.Common.domain + '/wx/share/delete?id=' + id + '&uid=1&callback=?', //开发环境
                        // url = window.Common.domain + '/wx/collect/collect?id=' + id + '&uid=1&callback=?', //开发环境 收藏
                        Li = $(this).closest('li');
